                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {sanitizedConfig.projects.external.projects.length !==
                      ...
                      <ExternalProjectCard
                        ...
                        subtitle={sanitizedConfig.projects.external.subtitle}
                        externalProjects={
                    ...
                    {sanitizedConfig.solutions &&
                      sanitizedConfig.solutions.projects.length !== 0 && (
                        <ExternalProjectCard
                          loading={loading}
                          header={sanitizedConfig.solutions.header}
                          subtitle={sanitizedConfig.solutions.subtitle}
                          externalProjects={sanitizedConfig.solutions.projects}
                          googleAnalyticId={sanitizedConfig.googleAnalytics.id}
                        />
                      )}
                    {sanitizedConfig.projects.github.display && (
                      <GithubProjectCard
                        ...
                        googleAnalyticsId={sanitizedConfig.googleAnalytics.id}
                        links={sanitizedConfig.projects.github.links}
                      />
                    )}
                    ...
                    {sanitizedConfig.apps &&
                      sanitizedConfig.apps.projects.length !== 0 && (
                        <ExternalProjectCard
                          loading={loading}
                          header={sanitizedConfig.apps.header}
                          subtitle={sanitizedConfig.apps.subtitle}
                          externalProjects={sanitizedConfig.apps.projects}
                          googleAnalyticId={sanitizedConfig.googleAnalytics.id}
                        />
                      )}
