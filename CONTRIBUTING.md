...
1. Make sure that the contribution you want to make is explained or detailed in a GitHub issue! Find an [existing issue]() or [open a new one](https://github.com/).
2. Once done, [fork the repository](https://github.com//fork) in your own GitHub account.
